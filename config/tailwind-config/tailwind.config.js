...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ["ConcreteFX", ...defaultTheme.fontFamily.sans],
        heading: ["Bomiro", ...defaultTheme.fontFamily.sans],
        concrete: ["ConcreteFX", ...defaultTheme.fontFamily.sans],
        bomiro: ["Bomiro", ...defaultTheme.fontFamily.sans],
      },
    },
  },
